            ...
            <div class="content">
                ...
                <?php
                    ...
                    $query = mysqli_query($conn, "SELECT usuario.nome as nome, cargo.nome as cargo, departamento.nome as departamento, filial.nome as filial FROM usuario, cargo, departamento, filial
                                                  WHERE usuario.cargo=cargo.idCargo AND usuario.departamento=departamento.idDep AND usuario.filial=filial.idFilial AND usuario.cargo='$cargo' AND usuario.ativada=1");
                    mysqli_close($conn);
                ?>
                <div id="print">
